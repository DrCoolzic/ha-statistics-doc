...
> For example of statistics from non-sensor domains see [Statistics domains](apdx2_stat_domains.md)
...
> See [Mysterious Statistics Fields](apdx1_stat_fields.md) for a detailed description of the fields `mean_weight`, and `created_ts`
